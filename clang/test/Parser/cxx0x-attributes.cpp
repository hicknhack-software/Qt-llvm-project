...
class FriendClassesWithAttributes {
  ...
  template <class _Tp, class _Alloc> friend class __declspec(dllexport) vector2;
  // But not C++11 ones
  ...
  friend struct __declspec(dllexport) TemplateStruct<FriendClassesWithAttributes>;
